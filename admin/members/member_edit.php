  ...
  <div class="content-wrapper">
    ...
    ?>
      ...
      <div class="box box-success">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="member_edit_proses.php" method="POST"">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="tmp_lahir" name="tmp_lahir" value="<?= $row['tempat_lahir']?>">
                </div>

                <div class="form-group">
                  <label for="tgl_lahir">Tanggal Lahir<span class="text-red">* </span><em> (mm/dd/yyyy)</em></label>
                  <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" value="<?= $row['tanggal_lahir']?>">
                </div>
                ...
                <div class="form-group">
                  ...
                  if ($jk == "Laki Laki") {
                    echo "
                          <div class='radio'>
                            <label>
                              <input checked type='radio' name='jk' id='lk' value='Laki Laki'>
                              Laki Laki
                            </label>
                          </div>
                          <div class='radio'>
                    ...
                    echo "
                          ...
                          <div class='radio'>
                            <label>
                              <input checked type='radio' name='jk' id='pr' value='Perempuan'>
                              Perempuan
                            </label>
                          </div>
                         ";
          ...
          <div class="box-footer">
            <a href="index.php" class="btn btn-default" href="index.php">Cancel</a>
