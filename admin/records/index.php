    ...
    <section class="content">
      ...
      <div class="box box-success">
         <div class="box-header with-border">
          ...
          <a href="record_print.php" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print</a>
          </div>
            <!-- /.box-header -->
            <div class="box-body">
                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                          echo "
                            <tr>
                              ...
                              <td>
                                <a href='member_edit.php?id=".$row['id']."' class='btn btn-info btn-xs' data-toggle='tooltip' title='Detail'><i class='fa fa-search'></i></a>
